...
from src.conversation import initialize_conversation_memory, session_manager
...
def main():
    ...
    try:
        ...
        st.markdown(
            "Upload a car part image or ask questions about car problems directly."
        )
...
def display_image_upload():
    ...
    uploaded_image = st.file_uploader(
        "Upload a photo of a car part", type=["jpg", "jpeg", "png"]
    )
            ...
            if uploaded_files and st.button("Update Knowledge Base"):
                with st.spinner("Processing documents..."):
                    try:
                        ...
                        st.info(
                            "In a production implementation, these documents would update the vector store."
                        )
            ...
            with st.expander("Debug Information"):
                st.write(
                    "Environment:",
                    {
                        ...
                        if k in ["MODEL_NAME", "DEBUG", "LOG_LEVEL"]
                    },
                )
